...
print(f"Precision: {precision:.3f}  (of flagged orders, this fraction were real mismatches —")
print("           deliberately liberal here since a false alarm just means a mild human")
print("           check, not lost money; see the cost reasoning immediately below)")
print(f"Recall:    {recall:.3f}  (of real mismatches, this fraction was caught)")
print(f"F1:        {f1:.3f}")
