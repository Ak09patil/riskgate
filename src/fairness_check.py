...
from pipeline import NEW_AGENT_AGE_DAYS, HIGH_VALUE_THRESHOLD, FRAUD_FEATURES, FRAUD_THRESHOLD
...
result_df = pd.DataFrame(rows).sort_values("fpr_to_fraud_rate_ratio", ascending=False)
